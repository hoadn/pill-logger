 ...
 */
public class AddConsumptionPillRecyclerAdapter extends RecyclerView.Adapter<AddConsumptionPillRecyclerAdapter.ViewHolder> {
    ...
    public AddConsumptionPillRecyclerAdapter(Context context, IConsumptionSelected activity, int textViewResourceId, List<Pill> pills, boolean showNewPill, ConsumptionRepository consumptionRepository) {
    ...
    private class buttonClick implements View.OnClickListener {
        ...
        public buttonClick(boolean add, TextView amount, View row, int position, AddConsumptionPillRecyclerAdapter adapter) {
            _add = add;
            _amount = amount;
            _row = row;
            _position = position;
